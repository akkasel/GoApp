...
func GetOrderById(c *gin.Context) {
	...
	docID, _ :=
		primitive.ObjectIDFromHex(orderID)
	...
	if err := orderCollection.FindOne(ctx,
		bson.M{"_id": docID}).Decode(&order); err != nil {
...
func DeleteOrder(c *gin.Context) {
	...
	result, err :=
		orderCollection.DeleteOne(ctx, bson.M{"_id": docID})
